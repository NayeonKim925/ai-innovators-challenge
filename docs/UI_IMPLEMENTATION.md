...
- [DESIGN.md](../DESIGN.md)가 디자인 원본이며 채택·제외 기준은 이 문서에 요약한다. 외부 레퍼런스 원본은 로컬 작업 산출물로 관리한다.
...
- 사용자 피드백에 따라 네이비·청록은 유지하고 둥근 카드 대시보드에서 조사 기록부형 콘솔로 바꿨다. 외부 레퍼런스의 적용·제외 기준은 위의 디자인 원칙과 이 문서의 화면별 결정에 반영했다.
